...
/**
 * @struct message_node
 * @brief  rappresenta un messaggio nella history di un utente, visto come un
 *         nodo di una lista
 *
 * @var data il messaggio
 * @var next il puntatore alla messaggio successivo
 */
typedef struct msgnode_struct {
	message_t data;
	struct msgnode_struct * next;
} msgnode;

typedef msgnode * msgcoda;
