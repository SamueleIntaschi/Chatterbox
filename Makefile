...
# 
FILE_DA_CONSEGNARE=Makefile chatty.c client.c message.h ops.h stats.h config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 connections.h \
		   icl_hash.h icl_hash.c connections.c mutex.h mutex.c \
                   history.h history.c codafd.h codafd.c group_hash.h group_hash.c \
                   usercoda.h usercoda.c configurazione.h configurazione.c \
                   relazione.pdf script.sh
# inserire il nome del tarball: es. NinoBixio
TARNAME=SamueleIntaschi
...
OBJECTS		= connections.o icl_hash.o mutex.o history.o codafd.o configurazione.o group_hash.o usercoda.o
